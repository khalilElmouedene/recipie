...
# --------- OpenAI -------------------------------------------------------- #
client = OpenAI(api_key="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")  # ← put your real OpenAI key instead of X
    ...
    try:
       ...
       #  2) Midjourney generation
        ...
        mj = MidjourneyApi(
            ...
            "1237876415471554623",
            "938956540159881230",
            "ODA4MzU0MzI4MDM2MjQ1NTA1.GJZw3K.iiulCd25VJNlpWNg-TI16tdbAa-hluUAAVXiKg"
        )
