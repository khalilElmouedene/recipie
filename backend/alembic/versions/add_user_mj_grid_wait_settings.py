"""add mj_timer_settings for configurable Midjourney grid wait only

Revision ID: add_user_mj_grid_wait_settings
Revises: drop_user_mj_timer_settings
...
revision = "add_user_mj_grid_wait_settings"
down_revision = "drop_user_mj_timer_settings"
branch_labels = None
depends_on = None
