        ...
        <>
          <div className="card mb-4 flex items-start gap-3 p-4 border-amber-800/50 bg-amber-950/20">
            ...
            <p className="text-sm text-amber-200/90">
              These keys are personal and shared across all your projects.
            </p>
          </div>
          ...
          {hasCredChanges && (
            <div className="flex justify-end mb-4">
              <button
                ...
                className="btn-primary flex items-center gap-2"
              >
                <Save size={16} /> {savingCreds ? "Saving..." : "Save"}
              </button>
            </div>
          )}
                ...
                <div className="space-y-3">
                  {group.keys.map((k) => (
                    <div key={k.key} className="border border-gray-700 rounded-lg p-3">
                      ...
                      {k.type === "textarea" ? (
                        <textarea
                          value={credValues[k.key] || ""}
                          onChange={(e) =>
                            setCredValues({ ...credValues, [k.key]: e.target.value })
                          }
          ...
          {hasCredChanges && (
            <div className="sticky bottom-4 flex justify-end mt-6">
              ...
              >
                <Save size={16} /> {savingCreds ? "Saving..." : "Save changes"}
              </button>
            </div>
          )}
        </>
                    ...
                    return (
                      <div key={key} className="border border-gray-700 rounded-lg p-3">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setPromptValues({ ...promptValues, [key]: e.target.value })
                          }
